 ...
 * ====================
 * Auto-cached : {sanitised source-qualified ID}.jpg  e.g. "OFF_3017620422003.jpg"
 ...
 * User-defined: {sanitised source-qualified ID}_custom.jpg
 *               Co-exists with the auto-cached counterpart on disk.
 *               The _custom suffix is the sole distinguishing marker.
 * Meal photos : {UUID}.jpg  - meals have no source ID; UUIDs are generated by
 *               the caller (ImagePickerHelper) and are filesystem-safe.
 */
public class ImageStorageManager {
    ...
    /**
     * Constructs a File for an auto-cached food product full-size image.
     *
     * @param sourceQualifiedId The item's source-qualified ID, e.g. "OFF:3017620422003".
     * @return A File at the expected path, or null if the directory is unavailable.
     */
    @Nullable
    public File getProductHeroFile(@NonNull String sourceQualifiedId) {
    ...
    /**
     * Constructs the File for a user-defined food product full-size image override.
     *
     * Naming convention: {sanitised_source_id}_custom.jpg
     * Example: "OFF:3017620422003" → products/OFF_3017620422003_custom.jpg
     *
     * Co-exists with the auto-cached counterpart (OFF_3017620422003.jpg) on disk.
     * The _custom suffix is the sole marker distinguishing user-defined images
     * from auto-cached ones - both files may be present simultaneously.
     * Removing the user-defined file restores display of the auto-cached version.
     *
     * @param sourceQualifiedId The item's source-qualified ID, e.g. "OFF:3017620422003".
     * @return A File at the expected path, or null if the directory is unavailable.
     */
    @Nullable
    public File getUserProductHeroFile(@NonNull String sourceQualifiedId) {
        File dir = getProductsDir();
        if (dir == null) return null;
        return new File(dir, sanitiseId(sourceQualifiedId) + "_custom.jpg");
    }
    ...
    /**
     * Constructs a File for an auto-cached recipe full-size image.
     *
     * @param sourceQualifiedId The item's source-qualified ID, e.g. "THEMEALDB:52772".
     * @return A File at the expected path, or null if the directory is unavailable.
     */
    @Nullable
    public File getRecipeHeroFile(@NonNull String sourceQualifiedId) {
    ...
    /**
     * Constructs the File for a user-defined recipe full-size image override.
     *
     * Naming convention: {sanitised_source_id}_custom.jpg
     * Example: "THEMEALDB:52772" → recipes/THEMEALDB_52772_custom.jpg
     *
     * Co-exists with the auto-cached counterpart (THEMEALDB_52772.jpg) on disk.
     * The _custom suffix is the sole marker distinguishing user-defined images
     * from auto-cached ones - both files may be present simultaneously.
     * Removing the user-defined file restores display of the auto-cached version.
     *
     ...
     */
    @Nullable
    public File getUserRecipeHeroFile(@NonNull String sourceQualifiedId) {
        File dir = getRecipesDir();
        if (dir == null) return null;
        return new File(dir, sanitiseId(sourceQualifiedId) + "_custom.jpg");
    }
     ...
     *
     * Meals have no source-qualified ID - UUID filenames are correct here.
     * UUID generation is the caller's responsibility.
     *
     * @param filename UUID-based filename with extension, e.g. "{UUID}.jpg".
     * @return A File at the expected path, or null if the directory is unavailable.
     */
    @Nullable
